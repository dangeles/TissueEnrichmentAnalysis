...
phenotype of interest afterwards~\cite{}. Currently, selection of screening
phenotypes is performed based on researcher experience.
...
cell size or shape\cite{}; alternatively, cuticle development can alter body
shape~\cite{}; finally, muscles can alter the effective body length
due to their contraction state~\cite{}.
